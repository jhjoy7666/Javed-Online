    ...
    return (
      <div className="min-h-screen bg-[#f2f4f7] flex flex-col items-center justify-center p-8 max-w-md mx-auto shadow-2xl relative overflow-hidden">
        ...
        <motion.button 
          ...
          className="w-full max-w-xs flex items-center justify-center gap-3 bg-white text-[#344054] py-4 px-6 rounded-2xl font-bold border border-[#d0d5dd] shadow-sm hover:bg-[#F9FAFB] transition-all active:scale-[0.98] group"
        >
